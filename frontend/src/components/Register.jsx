  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="glass-card w-full max-w-md p-8 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-32 h-32 bg-violet-500/20 rounded-full blur-[40px] pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-indigo-500/20 rounded-full blur-[40px] pointer-events-none" />
        ...
        <div className="relative text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm">Join us to start managing your items</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full btn-primary disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center h-12"
          >
            {isLoading ? (
